...
public class Controller {
	...
	/* Sun */
	public void setSunCount(JLabel cnt) {this.sunCount = cnt;}
	public void setSunCount(int cnt) {this.sunCount.setText("" + cnt);}
	public void addSunCount(int cnt){setSunCount(cnt + getIntSunCount());}
	public JLabel getSunCount(){return this.sunCount;}
	public int getIntSunCount(){return Integer.parseInt(this.sunCount.getText());}
	...
	/* Plant */
	public Plant[][] getPlants(){return this.plants;}
	public Map<String, Plant> getPlantMap(){return plantMap;}
	...
	public void setSelectedIndex(int x) {this.selectedIndex = x;}
	...
	/* Shovel */
	public void setShovel(Shovel shovel) {this.shovel = shovel;}
	...
	public void setP(Point p) {this.mouseP = p;}

	public JPanel getTopPanel() {return topPanel;}

	public void setPreImg(ImageIcon preImg) {this.preImg = preImg;}

	public void setBlurImg(ImageIcon blurImg) {this.blurImg = blurImg;}
