...
public class Card extends JLabel implements MouseListener, Runnable{
	...
	public void setRectangle(int x, int y, int w, int h){this.rectangle = new Rectangle(x, y, w, h);}
	public Rectangle getRectangle(){return rectangle;}
	public void setInCooling(boolean b) {this.inCooling = b;}
	public boolean getInCooling() {return inCooling;}
	public int getPrice() {return price;}
	public String getCardName() {return cardName;}
	public int getCardWidth() {return cardWidth;}
	public int getCardHeight() {return cardHeight;}
	public void setChoosed(boolean choosed) {this.isChoosed = choosed;}
